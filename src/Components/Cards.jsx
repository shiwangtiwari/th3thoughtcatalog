...
function Cards() {
  return (
    <div className='w-full min-h-screen bg-zinc-100 flex flex-col items-center px-5 py-5 md:py-24 md:px-24 gap-5' id="insights">
      <div className="cardcontainer w-full md:w-1/2">
        <div className="card relative w-full rounded-xl h-[40vh] md:h-[50vh] bg-[#004D43] flex items-center justify-center">
          ...
          <button className="absolute text-sm h-auto w-auto md:h-[2vw] w-[9vw] px-5 border-2 rounded-full left-10 bottom-10">&copy;2023-2024</button>
        </div>
      </div>
