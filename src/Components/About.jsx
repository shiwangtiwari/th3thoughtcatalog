    ...
    <div className="w-full p-5 md:p-20 bg-[#CDEA68] rounded-tl-3xl rounded-tr-3xl text-black" id="about">
      ...
      <div className="w-full flex flex-col md:flex-row border-t-[2px] pt-10 mt-10 md:mt-20 border-[#a1b562]">
        <div className="w-full md:w-1/2 md:pr-5">
          ...
          <button className="flex uppercase gap-3 md:gap-10 items-center px-5 md:px-10 py-4 md:py-6 bg-zinc-900 rounded-full mt-5 md:mt-10 text-white">Read More
          <div className="w-1 h-1 md:w-2 md:h-2 bg-zinc-100 rounded-full"></div></button>
        </div>
